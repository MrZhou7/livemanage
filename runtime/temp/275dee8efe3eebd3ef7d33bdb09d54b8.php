<?php /*a:1:{s:77:"G:\PhpStudy\PHPTutorial\WWW\livemanage\application\api\view\web\stat\avg.html";i:1603251785;}*/ ?>
<!DOCTYPE html>
<html>

<head>
    <meta charset="UTF-8">
    <title>解决问题平均时长</title>
    <meta name="Description" content="现场管理" />
    <meta name="renderer" content="解决问题平均时长">
    ...
    <div class="layui-fluid">
        <div class="layui-row well">
            <div class="layui-col-sm4">
                ...
                <div class="layui-input-block">
                    <input readonly type="text" name="date" class="layui-input">
                </div>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        layui.use(['form', 'laytpl'], function () {
            ...
            $(document).on('click', '#btn', function () {
                $.ajax({
                    type: "post",
                    url: "<?php echo url('web/stat/avgtime'); ?>",
                    dataType: "json",
                    contentType: "application/json",
                    async: false,
