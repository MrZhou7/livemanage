<?php /*a:1:{s:81:"G:\PhpStudy\PHPTutorial\WWW\livemanage\application\api\view\web\stat\produce.html";i:1603251730;}*/ ?>
<!DOCTYPE html>
<html>
...
<head>
    ...
    <meta name="renderer" content="提报问题数量">
    ...
    <script type="text/javascript">
        ...
        layui.use(['form', 'laytpl'], function () {
            ...
            $(document).on('click', '#btn', function () {
                $.ajax({
                    type: "post",
                    url: "<?php echo url('web/stat/produceProblem'); ?>",
                    dataType: "json",
                    contentType: "application/json",
                    async: false,
