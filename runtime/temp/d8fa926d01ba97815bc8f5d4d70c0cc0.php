<?php /*a:1:{s:83:"G:\PhpStudy\PHPTutorial\WWW\livemanage\application\api\view\web\stat\important.html";i:1603250897;}*/ ?>
<!DOCTYPE html>
<html>
...
<head>
    ...
    <meta name="renderer" content="重要事件汇总">
    ...
    <script type="text/javascript">
        ...
        layui.use(['form', 'laytpl', 'table'], function () {
            ...
            var tableIns = table.render({
                elem: '#tableData'
                , method: "post"
                , url: "<?php echo url('web/stat/importantList'); ?>"
                ...
                , cols: [[
                    ...
                    , { field: 'important', title: '重要事项', sort: true, minWidth: 150 }
